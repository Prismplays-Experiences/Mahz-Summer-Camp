local GuiContents = {}
local MouseMovement = require("@Modules/MouseRegister")
local RadialGrow = require("@Modules/RadialGrow")
...
GuiContents["Radial"] = function(Guibtn)
	...
	for _ = 0, count, 1 do
		spawn(function()
			...
			goal.Position = UDim2.new(
				0,
				particle.Position.X.Offset + (math.random(-50, 50)),
				0,
				particle.Position.Y.Offset + (math.random(-50, 50))
			)
			goal.Transparency = 1
