...
function TopButtons(btn)
	...
	btn.MouseButton1Click:Connect(function()
		TweenService:Create(Frame:WaitForChild('InnerFrame'):WaitForChild('ScrollingFrame'),TweenInfo.new(0.7),{CanvasPosition = pos}):Play()
	end)
end
...
function Shop:KnitStart()
	...
	for i,v in Frame:WaitForChild('TabsFrame'):GetChildren() do
		task.spawn(function()
