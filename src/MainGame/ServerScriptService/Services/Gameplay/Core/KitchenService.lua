...
local KitchenFoodInfo = require(Info:WaitForChild("KitchenFoods"))
...
function PickFoodSpawnPoint()
    local Item
    repeat task.wait() Item = KitchenFoodSpawnPoints:GetChildren()[math.random(1,#KitchenFoodSpawnPoints:GetChildren())]
