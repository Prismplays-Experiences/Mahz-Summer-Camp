...
function FoodController:KnitStart()
    ...
    self.KitchenService.FoodEaten:Connect(function(foodName, weightLoss, isHighFood)
    ...
    self.KitchenService.FoodReady:Connect(function()
        HardNotification.Send(Player,'Head to the kitchen! Food is ready!','rbxassetid://96017356444520',SoundEffects.FoodReady,2.5)
    end)
